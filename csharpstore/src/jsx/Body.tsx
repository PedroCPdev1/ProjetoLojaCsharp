    ...
    return (
        <><div className='Body flex justify-center '>
            ...
            <div className="max-w-80 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 m-10">
                ...
                <div className="p-5">
                    <a href="#">
                        <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Banana</h2>
                    </a>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Bananas</p>
